...
(function () {
  ...
  wp.data.subscribe(function () {
    //catch any time our block changes. (work with up-to-date data.)
...
wp.blocks.registerBlockType("ourplugin/are-you-paying-attention", {
  ...
  attributes: {
    ...
    //default here is an array of actual answer strings
    correctAnswer: {
      type: "number",
      default: undefined
    },
...
function EditComponent(props) {
  ...
  function deleteAnswer(indexToDelete) {
    ...
    if (indexToDelete == props.attributes.correctAnswer) {
      ...
      }); //Because we've deleted wrong answer here.
    }
  }
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    onClick: () => {
      props.setAttributes({
        ...
        /*undefined here is used to differentiate new value with previous values.*/
